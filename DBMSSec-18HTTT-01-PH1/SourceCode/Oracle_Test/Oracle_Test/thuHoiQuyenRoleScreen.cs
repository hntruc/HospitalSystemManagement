...
{
    public partial class thuHoiQuyenRoleScreen : Form
    {
        public thuHoiQuyenRoleScreen()
        {
            InitializeComponent();
        }
        ...
        private void xem_btn_Click(object sender, EventArgs e)
        {
            ...
            string command = "select TABLE_NAME, PRIVILEGE from dba_tab_privs where GRANTEE =" + "'" + role_text.Text.ToUpper() + "'";
            try
            {
