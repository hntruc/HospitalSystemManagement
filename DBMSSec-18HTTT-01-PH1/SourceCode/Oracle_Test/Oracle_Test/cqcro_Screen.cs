...
{
    public partial class cqcro_Screen : Form
    {
        public cqcro_Screen()
        {
            InitializeComponent();
        ...
        int flag = 0;
        private void cqcro_Screen_Load(object sender, EventArgs e)
        {
        ...
        private void cq_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (OracleCommand cmd = new OracleCommand("admin1.grantQuyenObject", con))
                {
                    ...
                    cmd.Parameters.Add("username", OracleDbType.NVarchar2).Value = rolename_text.Text;
